...
<link rel="stylesheet" href="{{ asset('public/plugin/editor/css/pygment_trac.css') }}">
<link rel="stylesheet" href="{{ asset('public/plugin/editor/css/editor.css') }}">
<script type="text/javascript" src="{{ asset('public/plugin/editor/js/highlight.js') }}"></script>
<script type="text/javascript" src="{{ asset('public/plugin/editor/js/modal.js') }}"></script>
<script type="text/javascript" src="{{ asset('public/plugin/editor/js/MIDI.js') }}"></script>
<script type="text/javascript" src="{{ asset('public/plugin/editor/js/fileupload.js') }}"></script>
<script type="text/javascript" src="{{ asset('public/plugin/editor/js/bacheditor.js') }}"></script>
<meta name="csrf-token" content="{{ csrf_token() }}" />
<script type="text/javascript" src="{{ asset('public/plugin/editor/js/bootstrap3-typeahead.js') }}"></script>
